 ...
 */
public class StringInMethodParser extends RobotSuiteParser {
    ...
    public StringInMethodParser() {

    }

    public StringInMethodParser(String methodString) {
        this.methodString = methodString;
    }

    public StringInMethodParser(StringInMethodParser args) {
    ...
    public String printStringsInMethod(List<StringInMethodParser> listStringMethod) {
        String result = "";
        boolean isExist = false;
        for (StringInMethodParser oneString : listStringMethod) {
    ...
    public String printOneString(StringInMethodParser stringMethod, boolean isExist) {
        String result = "";
    ...
    public StringInMethodParser convertStringMethod(String oneString) {
        convertToStringMethod(oneString);
        return this;
    }

    private StringInMethodParser convertToStringMethod(String oneString) {
        String variable = "";
        String nextString = "";
